...
def SCDD_eval_all(preds, labels, num_class):
    ...
    hist_n1 = c2hist[1][1].copy
    hist_n2 = c2hist.copy()
    hist_n2[1][1] = 0
    Sek0 = cal_kappa(hist_n2)
    Sek1 = cal_kappa(hist_n1)
    mSek = (Sek0+Sek1)/2
    ...
    score = 0.7*Sek+0.3*IoU_mean
    return Fscd, IoU_mean, Sek, score, SC_Precision, SC_Recall, Sek0, Sek1, mSek
