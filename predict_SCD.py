...
class PredOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--test_dir', required=False, default='../HRSCD_417/test', help='directory to test images')
        parser.add_argument('--pred_dir', required=False, default='/predict/' + DATA_NAME + NET_NAME,
                            help='directory to output masks')
        parser.add_argument('--chkpt_path', required=False,
                            default=working_path + '/checkpoints/HRSCD2025/HRSCD3/HRSCD3_8e_mIoU63.47_Sek-1.04_Fscd44.36_OA89.04_Pre46.45_Rec42.45_sroce18.32.pth')
